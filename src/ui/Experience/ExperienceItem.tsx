    ...
    >
      <div className="flex flex-row justify-between items-end">
        <div className="flex flex-row gap-6">
          <motion.div
            className="w-[90px] h-[90px] rounded-2xl overflow-hidden transition-all duration-500"
            style={{
              boxShadow:
          ...
          <div className="flex flex-col relative z-1 justify-evenly">
            <p className="text-center text-[36px] font-bold leading-[1.4em] tracking-[-0.02em] text-[rgba(209,213,230,0.87)] font-sans w-fit">
            ...
            <p className="text-center text-[20px] font-medium leading-[1.4em] tracking-[-0.02em] text-[rgba(209,213,230,0.69)] font-sans w-fit">
        ...
        {/* <BadgeInfo color="rgb(173, 173, 173)" size={32} cursor={"pointer"} /> */}
        {/* <div
          className="w-fit flex flex-col gap-1 transition-all duration-300 cursor-pointer"
          style={{
            backdropFilter: "blur(10px)",
            background: "rgba(255, 255, 255, 0.02)",
            borderRadius: 20,
        ...
        >
          <BadgeInfo color="rgb(173, 173, 173)" size={32} />
        </div> */}
      </div>
      <div className="ml-[114px] mt-[10px] flex flex-col gap-2">
      ...
      <div className="ml-[114px] mt-[10px] text-white flex gap-3">
